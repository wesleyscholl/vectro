...
Examples:
  ...
  python benchmarks/benchmark_python_fallback.py --output results/fallback_benchmark.json
    ...
    parser.add_argument("--output", type=str, default="results/fallback_benchmark.json", help="Output JSON file path")
    parser.add_argument("--dims", type=int, nargs="+", default=[768], help="Dimensions to benchmark (default: 768)")
