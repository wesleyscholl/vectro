...
def benchmark_quality_on_real_data(
    ...
    for profile in profiles:
        ...
        try:
            ...
            print(f" cosine_sim={results[profile]['mean_cosine_similarity']:.5f}, ratio={compression_ratio:.1f}x, {throughput:.0f} vec/s")
        except Exception as e:
            print(f" ERROR: {e}")
...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="glove-100", choices=["glove-100", "sift1m"], help="Dataset to use")
    parser.add_argument("--output", type=str, default="results/real_embeddings_benchmark.json", help="Output JSON file")
