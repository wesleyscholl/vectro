...
class TestQualityAnalysis(unittest.TestCase):
    ...
    def test_quality_evaluation(self):
        ...
        metrics = self.analyzer.evaluate_quality(self.original, self.reconstructed, compression_ratio=3.5)
...
class TestCompressionProfiles(unittest.TestCase):
    ...
    def test_custom_profile_creation(self):
        ...
        custom = create_custom_profile("test_profile", quantization_bits=6, range_factor=0.92, min_similarity_threshold=0.993)
    ...
    def test_profile_optimization(self):
        ...
        optimized = optimizer.auto_optimize_profile(self.test_vectors, target_similarity=0.995, target_compression=3.0)
...
class TestFileIO(unittest.TestCase):
    ...
    def test_save_load_compressed(self):
        ...
        try:
            ...
            np.testing.assert_array_almost_equal(original_decompressed, loaded_decompressed, decimal=6)
...
def run_all_tests():
    ...
    test_classes = [TestVectroCore, TestBatchProcessing, TestQualityAnalysis, TestCompressionProfiles, TestConvenienceFunctions, TestFileIO, TestErrorHandling]
