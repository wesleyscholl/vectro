...
def run_mojo_tests():
    ...
    mojo_test_files = ["tests/test_vector_quantizer.mojo", "tests/test_batch_processor.mojo", "tests/test_compression_profiles.mojo", "tests/test_performance_regression.mojo"]
