    ...
    def auto_optimize_profile(sample_vectors: np.ndarray, target_similarity: float = 0.995, target_compression: float = 3.0, max_iterations: int = 10) -> CompressionProfile:
        ...
        for range_factor in range_factors:
            for clipping_percentile in clipping_percentiles:
                ...
                score = CompressionOptimizer._evaluate_profile(test_profile, sample_vectors, target_similarity, target_compression)
        ...
        for profile_name in profile_names:
            try:
                ...
                results[profile_name] = {
                    ...
                    "passes_threshold": quality.passes_quality_threshold(profile.min_similarity_threshold),
...
def create_custom_profile(name: str, quantization_bits: int = 8, range_factor: float = 0.95, **kwargs) -> CompressionProfile:
    ...
    return CompressionProfile(name=name, quantization_bits=quantization_bits, range_factor=range_factor, **defaults)
